...
{
    jQuery('body').append('<a href="javascript:void(0)" onclick="jQuery(\'html,body\').animate({scrollTop: 0},300);" class="go_top _tipsy" title="Lên đầu trang" style="display:none"></a>');
