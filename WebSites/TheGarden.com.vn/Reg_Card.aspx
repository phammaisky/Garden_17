<%@ page language="C#" autoeventwireup="true" inherits="_Reg_Card, App_Web_pm5ajuum" enableviewstatemac="false" enableEventValidation="false" smartnavigation="true" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Đăng ký thẻ The Garden Club</title>
    ...
    <div id="site-content">
        <div class="popup_join contact-bg" style="margin: 30px auto; text-align: left; border: 1px solid #C6C4C5;
            ...
            <div class="contact-header">
                <div class="contact-h">
                    Đăng ký làm thẻ The Garden Club
                </div>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4" style="font-size: 12px; font-weight: bold">
                                    Tham gia để nhận ưu đãi cùng hàng trăm ngàn thành viên The Garden
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="t-col2">
                                    <asp:TextBox ID="Address_tbx" runat="server" CssClass="contact-txt" Style="width: 140px"></asp:TextBox>
                                </td>
                                <td class="t-col1" style="font-size: 14px; font-weight: bold;">
                                    Ngày sinh:
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="t-col2">
                                    <asp:TextBox ID="Identity_Number_tbx" runat="server" CssClass="contact-txt" Style="width: 140px"></asp:TextBox>
                                </td>
                                <td colspan="2" style="font-size: 12px;">
                                    <div align="center">
                                        <asp:CheckBox ID="Agree_cbx" runat="server" Text="Tôi đồng ý đăng ký làm thẻ<br/>The Garden Club"
                                            Checked="true" />
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div style="font-size: 9px; line-height: 14px; padding: 8px; text-align: justify">
                                        Bằng viêc bấm nút đăng ký, Quý khách hàng đã đồng ý cho TTTM The Garden sử dụng
                                        những thông tin đã cung cấp. Tất cả dữ liệu cá nhân của Khách hàng sẽ được bảo mật.
                                    </div>
                                </td>
                            </tr>
                        </tbody>
