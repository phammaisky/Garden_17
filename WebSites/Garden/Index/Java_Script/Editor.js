    ...
    if (Check_Element_Is_Not_Null(Editor_ID)) {
        ...
        try {
            tinymce.init({
                ...
                body_class: $('#Index_Host_hdf').val() + '/index/Java_Script/tinymce/HTML_Editor.css',
                content_css: $('#Index_Host_hdf').val() + '/index/Java_Script/tinymce/HTML_Editor.css',
                editor_css: $('#Index_Host_hdf').val() + '/index/Java_Script/tinymce/HTML_Editor.css',
